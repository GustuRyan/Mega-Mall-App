...
import 'package:hr_360/presentation/module/profile_data/competency/widget/form_profile_competency.dart';

class ProfileCompetencyScreen
    extends GetResponsiveView<ProfileCompetencyController> {
  ProfileCompetencyScreen({super.key});
  @override
    ...
    return PopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SafeArea(child: FormProfileCompetencyWidget()),
