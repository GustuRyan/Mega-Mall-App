...
import 'package:hr_360/presentation/module/profile_data/education/widget/form_profile_education.dart';

class ProfileEducationScreen
    extends GetResponsiveView<ProfileEducationController> {
  ProfileEducationScreen({super.key});
  @override
    ...
    return PopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SafeArea(child: FormProfileEducationWidget()),
