...
import 'package:hr_360/presentation/module/profile_data/family/widget/form_profile_family.dart';

class ProfileFamilyScreen extends GetResponsiveView<ProfileFamilyController> {
  ProfileFamilyScreen({super.key});
  @override
    ...
    return PopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SafeArea(child: FormProfileFamilyWidget()),
